      ...
      <el-row :gutter="16">
        ...
        <el-col :span="12">
          <el-form-item label="账号类型">
            ...
            >
              <el-option
                v-for="item in feedTaskAccountTypeOptions"
                :key="item.value"
                v-bind="item"
              />
            </el-select>
        ...
        <el-col :span="12">
          <el-form-item label="账号状态">
            <el-select
              v-model="draft.accountState"
              clearable
              class="w-full"
              placeholder="全部状态"
            >
              <el-option
                v-for="item in feedTaskAccountStateOptions"
                :key="item.value"
                v-bind="item"
              />
            </el-select>
        ...
        <el-col :span="12">
          <el-form-item label="登录状态">
            <el-select
              v-model="draft.loginState"
              clearable
              class="w-full"
              placeholder="全部状态"
            >
              <el-option
                v-for="item in feedTaskLoginStateOptions"
                :key="item.value"
                v-bind="item"
              />
            </el-select>
        ...
        <el-col :span="12">
          <el-form-item label="号码来源">
            <el-select
              v-model="draft.numberSource"
              clearable
              class="w-full"
              placeholder="全部来源"
            >
              <el-option
                v-for="item in feedTaskSourceOptions"
                :key="item.value"
                v-bind="item"
              />
            </el-select>
